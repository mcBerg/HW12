...
public class WeatherService extends IntentService {
    ...
    private static final String BASE_URL = "https://api.darksky.net/forecast/0fe461505e2549c57117f0899055279b/";
    ...
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            URL url = new URL(BASE_URL + lat +","+lon+"?exclude=minutely,hourly,daily,alerts,flags");
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                String summary = (String)current.get("summary");
